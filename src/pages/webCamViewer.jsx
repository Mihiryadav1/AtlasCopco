...
const WebCamViewer = () => {
    ...
    return (
        <div className='flex container-md justify-between sm:ml-56  px-4 sm:pt-20 bg-white border-2 h-full'>
            <div className='flex flex-col w-full '>
                <div className="container background-gray rounded-md flex h-screen">
                    <div className="user-information w-4/6 h-full p-3">
                        <h2>User Details</h2>
                    </div>
                    <div className="bg-black w-full h-98">
                        {videoRef && (
